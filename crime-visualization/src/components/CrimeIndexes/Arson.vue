...
export default {
      ...
      chartOptions: {
        ...
        yaxis: {
          title: {
            ...
            style: {
              cssClass: 'arson-yaxis-title',
              fontSize: '18px'
            }
          },
          labels: {
            style: {
              cssClass: 'arson-yaxis-label',
              fontSize: '18px'
            }
          }
        },
  ...
  methods: {
    updateChart() {
      ...
      for (let i = 0; i < this.city.arson.length; i++) {
        percentages[i + 2012] = Math.floor(this.city.arson[i] / (this.city.arson[i] + this.state.arson[i]) * 100);
      }
