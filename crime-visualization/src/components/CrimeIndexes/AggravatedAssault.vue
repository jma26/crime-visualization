...
export default {
    ...
    return {
      chartOptions: {
        ...
        xaxis: {
          ...
          labels: {
            style: {
              cssClass: 'aggravatedAssault-xaxis-label',
              fontSize: '16px'
            }
          }
        },
        yaxis: {
          title: {
            ...
            style: {
              cssClass: 'aggravatedAssault-yaxis-title',
              fontSize: '18px'
            }
          },
          labels: {
            style: {
              cssClass: 'aggravatedAssault-yaxis-label',
              fontSize: '18px'
            }
          }
        },
  ...
  methods: {
    updateChart() {
      ...
      for (let i = 0; i < this.city.aggravated_assault.length; i++) {
        percentages[i + 2012] = Math.floor(this.city.aggravated_assault[i] / (this.city.aggravated_assault[i] + this.state.aggravated_assault[i]) * 100);
      }
