...
export default {
      ...
      chartOptions: {
        ...
        yaxis: {
          title: {
            ...
            style: {
              cssClass: 'rape-yaxis-title',
              fontSize: '18px'
            }
          },
          labels: {
            style: {
              cssClass: 'rape-yaxis-label',
              fontSize: '18px'
            }
          }
        },
  ...
  methods: {
    updateChart() {
      ...
      for (let i = 0; i < this.city.rape.length; i++) {
        percentages[i + 2012] = Math.floor(this.city.rape[i] / (this.city.rape[i] + this.state.rape[i]) * 100);
      }
